...
class CoreCheckoutActivationLog
{
     ...
     * Set requestedBy
     *
     * @param \Adteam\Core\Authorization\Entity\OauthUsers $requestedBy
     *
     * @return CoreCheckoutActivationLog
     */
    public function setRequestedBy(\Adteam\Core\Authorization\Entity\OauthUsers $requestedBy = null)
    {
