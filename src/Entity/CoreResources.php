 ...
 * @ORM\Entity(repositoryClass="Adteam\Core\Authorization\Repository\CoreResourcesRepository")
 */
class CoreResources
{
    /**
     ...
     * Set parent
     *
     * @param \Adteam\Core\Authorization\Entity\CoreResources $parent
     *
     * @return CoreResources
     */
    public function setParent(\Adteam\Core\Authorization\Entity\CoreResources $parent = null)
    {
        $this->parent = $parent;
