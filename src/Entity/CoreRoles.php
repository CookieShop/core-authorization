 ...
 * @ORM\Entity(repositoryClass="Adteam\Core\Authorization\Repository\CoreRolesRepository")
 */
class CoreRoles
{
    /**
     ...
     * Set parent
     *
     * @param \Adteam\Core\Authorization\Entity\CoreRoles $parent
     *
     * @return CoreRoles
     */
    public function setParent(\Adteam\Core\Authorization\Entity\CoreRoles $parent = null)
    {
        $this->parent = $parent;
