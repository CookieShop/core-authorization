...
class CoreProductCategories
{
     ...
     * Set parent
     *
     * @param \Adteam\Core\Authorization\Entity\CoreProductCategories $parent
     *
     * @return CoreProductCategories
     */
    public function setParent(\Adteam\Core\Authorization\Entity\CoreProductCategories $parent = null)
    {
        $this->parent = $parent;
